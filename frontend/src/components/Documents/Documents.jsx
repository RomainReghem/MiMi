                                ...
                                <Stack key={i} w={'100%'}>
                                    ...
                                    {stud.files.map((file, i) =>
                                        <Stack direction={'row'} key={i} w={'100%'}>
                                            ...
                                            <Tooltip label="Renommer" fontSize='md' placement="top">
                                                <IconButton colorScheme={'teal'} onClick={() => { onOpen(); setRenaming(file) }} icon={<FontAwesomeIcon icon={faPencil} />}></IconButton>
                                            </Tooltip>
                                            <Tooltip bg={'red.400'} label="Supprimer" fontSize='md' placement="top">
                                                <IconButton colorScheme={'red'} onClick={(e) => { deleteFile(file) }} icon={<FontAwesomeIcon icon={faXmark} />}></IconButton>
                                            </Tooltip>
                                        </Stack>
                                    )}
                                </Stack>
